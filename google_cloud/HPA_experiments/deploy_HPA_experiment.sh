...
# kubectl expose deployment hello-world --type=LoadBalancer --name=my-external-prometheus
# kubectl expose deployment hello-world --type=LoadBalancer --name=my-external-grafana
# kubectl expose deployment hello-world --type=LoadBalancer --name=my-external-flink
