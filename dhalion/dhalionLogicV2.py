        ...
        if float(previous_scaling_event) == 0:
            ...
            if float(latency_value) > latency_threshold \
                ...
                new_number_of_taskmanagers = math.ceil(
                    current_number_of_taskmanagers * increase_factor * overprovisioning_factor)
            ...
            # Overprovisioning if
                ...
                # CPU_utilization < CPU_utilization (cpu_lower_threshold)
                    ...
                    and current_number_of_taskmanagers > min_replicas \
            ...
            # Adjust number of taskmanagers if changed
