...
data = pd.DataFrame({"Auto-scaler": name, "Metric value": metric_per_autoscaler, "Latency (s)": latency_per_autoscaler,
                     "Taskmanagers": taskmanagers_per_autoscaler, "Latency + Taskmanagers": combined_per_autoscaler,
                     "Scaling operations": rescales_per_autoscaler})
