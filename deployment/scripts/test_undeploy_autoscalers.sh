...
echo "Undeploying autoscaler: $AUTOSCALER with query $QUERY on mode $MODE"
...
case $AUTOSCALER in
  "dhalion")
    envsubst < ../yamls/autoscalers/dhalion/deployment_dhalion.yaml | kubectl delete -f -
    ;;

  "hpa-cpu")
    envsubst < ../yamls/autoscalers/hpa/deployment_hpa_cpu.yaml | kubectl delete -f -
    ;;
  *)
esac
