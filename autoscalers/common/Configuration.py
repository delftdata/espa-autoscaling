...
class Configurations:
    ...
    NONREACTIVE_WAIT_TIME_AFTER_JOBMANAGER_DELETION_SECONDS = int(os.environ.get(
        "NONREACTIVE_WAIT_TIME_AFTER_JOBMANAGER_DELETION_SECONDS", "5"))
    ...
    def printConfigurations(self):
        ...
        print(f"\tNONREACTIVE_WAIT_TIME_AFTER_JOBMANAGER_DELETION_SECONDS: "
              f"{self.NONREACTIVE_WAIT_TIME_AFTER_JOBMANAGER_DELETION_SECONDS}")
