...
class AdaptDesiredParallelismTest(unittest.TestCase):
    ...
    def test_adaptation(self):
        ...
        d = scale_manager._adapt_scaling_to_existing_resources(desired_parallelisms=desired_parallelisms)
    ...
    def __test_scaleOperations_unequalParallelism(self, currentParallelism, desiredParallelism):
            ...
            with self.assertRaises(Exception) as context:
                scale_manager.perform_scale_operations(currentParallelism, desiredParallelism)
    ...
    def test_overprovisioning_factor_ensure_configuration_use(self):
        ...
        scale_manager = ScaleManager(config, None)
        self.assertEqual(
            scale_manager._calculate_parallelism_including_overprovisioning_factor(5),
            scale_manager._calculate_parallelism_including_overprovisioning_factor(5, overprovisioning_factor=1.2)
        )
    ...
    def test_overprovisioning_factor_test_calculation(self):
        ...
        self.assertEqual(
            100,
            scale_manager._calculate_parallelism_including_overprovisioning_factor(100, overprovisioning_factor=1)
        )
        self.assertEqual(
            5,
            scale_manager._calculate_parallelism_including_overprovisioning_factor(4, overprovisioning_factor=1.2)
        )
        self.assertEqual(
            6,
            scale_manager._calculate_parallelism_including_overprovisioning_factor(5, overprovisioning_factor=1.2)
        ...
        self.assertEqual(
            8,
            scale_manager._calculate_parallelism_including_overprovisioning_factor(6, overprovisioning_factor=1.2)
        )
        self.assertEqual(
            201,
            scale_manager._calculate_parallelism_including_overprovisioning_factor(100, overprovisioning_factor=2.000001)
        )
    ...
    def test_overprovisioning_factor_test_list_change(self):
        ...
        scale_manager._add_overprovisioning_factor_to_desired_parallelism(desired_parallelisms, overprovisioning_factor=1.25)
