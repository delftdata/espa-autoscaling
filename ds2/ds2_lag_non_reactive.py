...
def run():
    while True:
        ...
        if (current_number_of_taskmanagers > number_of_taskmanagers and float(latency_value) < scale_down_lag_threshold) or (current_number_of_taskmanagers < number_of_taskmanagers and float(latency_value) > scale_up_lag_threshold) and float(previous_scaling_event) == 0:
