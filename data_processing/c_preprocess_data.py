...
def combine_all_metrics(query, auto_scaler, percentage, load_pattern):
    ...
    path_to_files = "../experiment_data/" + query + "/" + load_pattern + "/" + auto_scaler + "/" + percentage + "/"
    ...
    input_data.to_csv("../experiment_data_processed/full_data/" + load_pattern + "/" + query + "/" + query + "_" + auto_scaler + "_" + percentage + ".csv")
